...
public class test  {
	...
	// maybe windowhandel close button(xpath: //button[contains(text(),"Close")])
		...
		//driver.findElement(By.xpath("//a[contains(text(),'Default project')]")).click();
		// click on default project (xpath: //a[contains(text(),"Default project")])

		// click on performance ??(xpath:
		//driver.findElement(By.xpath("//button[@class='blazemeter-button is-round is-round medium primary']")).click();
		// creat new test ( xpzth: //button[@class="blazemeter-button is-round is-round
		// medium primary"])
		//driver.findElement(By.xpath(
		//		"//button[@class='btn create-test-button btn-v4-test create-new-test js-create-new-single-test create-new-test-v4 btn btn-default']"))
		//		.click();
		...
		//driver.findElement(By.xpath("//button[@class='shared-folders-link btn btn-link']")).click();
		...
		//driver.findElement(By.xpath("//button[@class='accept-shared-folders btn btn-primary']")).click();
		// click on accept button //button[@class='accept-shared-folders btn
		// btn-primary']
		//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

		//WebElement inputbox = driver.findElement(By.xpath("(//input[@class='slider-value-input form-control'])[2]"));
		//for (int i = 20; i > 1; i--)
			//inputbox.sendKeys(Keys.ARROW_DOWN);

		//driver.findElement(By.xpath("//span[@class='cell-true-false-toggler send-email-toggle js-checked']")).click();
		// turn of email notification //span[@class='cell-true-false-toggler
		// send-email-toggle js-checked']
		
		//driver.findElement(By.xpath("//button[@class='action-button btn btn-success btn-sm']")).click();

		// run test //button[contains(text(),'Run Test')]
		//driver.findElement(By.xpath("//button[contains(text(),'Launch Servers')]")).click();
		...
		//		.presenceOfElementLocated(By.xpath("//span[contains(text(),'Set Report as a Baseline')]")));
